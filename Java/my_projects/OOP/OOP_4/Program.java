...
import OOP.OOP_4.Heroes.MageClass.Monk;
import OOP.OOP_4.Heroes.MageClass.Wizard;
import OOP.OOP_4.Heroes.MeleeClass.Rogue;
import OOP.OOP_4.Heroes.MeleeClass.Spearman;
import OOP.OOP_4.Heroes.RangeClass.Crossbowman;
import OOP.OOP_4.Heroes.RangeClass.Sniper;

// import OOP.OOP_4.Heroes.MageClass.MageHero;
// import OOP.OOP_4.Heroes.MeleeClass.MeleeHero;
// import OOP.OOP_4.Heroes.RangeClass.RangeHero;

import OOP.OOP_4.Heroes.Peasant;
...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        for (TemplatePerson person : TeamRed) {
            System.out
                    .println("Команда красных бойцов: " + person.getClass().getSimpleName() + " " + person.toString());
        }
            ...
            for (TemplatePerson p : all) {
                ...
                if (TeamRed.contains(p)) {
                    ...
                    if (p instanceof Monk) {
                        // добавить применение заклинания
                        ((Monk) p).cast_spell(TeamRed.get(rand.nextInt(0, 10)));
                    } else if (p instanceof Wizard) {
                        // добавить применение заклинания
                        ((Wizard) p).cast_spell(TeamBlu.get(rand.nextInt(0, 10)));
                    } else
                        p.step(TeamBlu);
                    ...
                    if (p instanceof Monk) {
                        // добавить применение заклинания
                        ((Monk) p).cast_spell(TeamBlu.get(rand.nextInt(0, 10)));
                    } else if (p instanceof Wizard) {
                        // добавить применение заклинания
                        ((Wizard) p).cast_spell(TeamRed.get(rand.nextInt(0, 10)));
                    }
                    p.step(TeamRed);
                }
                System.out.println();
